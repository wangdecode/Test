...
namespace WebPMethod
{
    class WebP
    {
        ...
        {
            if (File.Exists(System.AppDomain.CurrentDomain.BaseDirectory + "libwebp.dll") && File.Exists(System.AppDomain.CurrentDomain.BaseDirectory + "libsharpyuv.dll")) return true;
            return false;
        }
